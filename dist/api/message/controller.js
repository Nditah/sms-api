            ...
            while (1) {
                switch (_context.prev = _context.next) {
                    case 0:
                        ...
                        _context.next = 6;
                        return _model2.default.find(filter).populate("user", "title surname given_name email phone credit blocked deleted").populate("created_by", "id phone email credit").populate("updated_by", "id phone email credit").skip(skip).limit(limit).sort(sort).select(projection).exec();
