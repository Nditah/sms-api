...
exports.patchRecord = exports.verifyOnlineTnx = exports.verifyBvn = exports.createRecord = exports.fetchSettlement = exports.queryOnlineTnx = exports.fetchRecord = undefined;
            ...
            while (1) {
                switch (_context2.prev = _context2.next) {
                    case 0:
                        ...
                        _context2.next = 12;
                        return (0, _services.getTransaction)({ id: id }, true);
                    ...
                    case 15:
                        _context2.next = 17;
                        return (0, _services.getTransaction)({ from: from, to: to, currency: currency, status: status }, false);
            ...
            while (1) {
                switch (_context3.prev = _context3.next) {
                    case 0:
                        ...
                        _context3.prev = 3;
                        _context3.next = 6;
                        return (0, _services.getSettlement)({ page: page, limit: limit, status: status });
            ...
            while (1) {
                switch (_context6.prev = _context6.next) {
                    case 0:
                        ...
                        _context6.prev = 1;
                        _context6.next = 4;
                        return (0, _services.verifyTransaction)(txref);
...
var patchRecord = exports.patchRecord = function () {
        ...
        return regeneratorRuntime.wrap(function _callee7$(_context7) {
            while (1) {
                switch (_context7.prev = _context7.next) {
                    ...
                    case 8:
                        return _context7.abrupt("return", (0, _lib.success)(res, 200, result, "Record patched successfully!"));
                    ...
                    case 11:
                        ...
                        return _context7.abrupt("return", (0, _lib.fail)(res, 500, "Error patching record. " + _context7.t0.message));
    ...
    return function patchRecord(_x13, _x14) {
...
// Logging
var logger = _log4js2.default.getLogger("[flutterwave]");
