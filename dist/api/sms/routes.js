 ...
 */
router.get("/sms", [_authorization.checkAuth, _authorization.isValidUser], _controller.fetchRecord);
 ...
 */
router.post("/sms", [_authorization.checkAuth, _authorization.isValidUser], _controller.createRecord);
 ...
 * @apiError 401 master access only.
 */
router.post("/sms/externally", _controller.createRecord);
router.get("/sms/externally", _controller.createRecord);
